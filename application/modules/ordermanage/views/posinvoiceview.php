    ...
    <div class="invoice-card">
        ...
        <div class="invoice_address">
            ...
            <div class="row-data">
                ...
                <?php if($storeinfo->isvatnumshow==1){?><h5 class="item-title">
                    <?php echo display('tinvat');?><?php if(!empty($storeinfo->vattinno)){echo ': '.$storeinfo->vattinno;} ?>
                </h5><?php } ?>
                ...
                <div class="invoice-data">
				  ...
				  $totalamount=0;
                    ...
                    <div class="row-data">
                        ...
                        <h5><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo $itemprice;?>
        ...
        <div class="invoice-footer mb-15">
            ...
            <div class="row-data">
                ...
                <h5 class="my-5"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                    <?php echo $billinfo->total_amount;?> <?php if($currency->position==2){echo $currency->curr_icon;}?>
                </h5>
            ...
            <div class="row-data">
                ...
                <h5 class="my-5">
                    <?php if($currency->position==1){echo $currency->curr_icon;}?><?php $sdcharge=0; if(empty($billinfo)){ echo $sdcharge;} else{echo $sdcharge=$billinfo->service_charge;} ?><?php if($currency->position==2){echo $currency->curr_icon;}?>
                </h5>
            ...
            <div class="row-data border-top">
                ...
                <h5 class="my-5"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                    <?php echo $billinfo->bill_amount;?> <?php if($currency->position==2){echo $currency->curr_icon;}?>
                </h5>
            ...
            <div class="row-data">
                ...
                <h5 class="my-5"><?php if($currency->position==1){echo $currency->curr_icon;}?>
                    <?php echo $customepaid; ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
            ...
            <div class="row-data">
                ...
                <h5 class="my-5"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo $changes; ?>
                    <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
        ...
        <div class="invoice_address">
            ...
            <div class="row-data">
                ...
                <div class="item-info">
                    ...
                    <h5 class="item-title"><?php echo display('billing_to');?>:
                        <?php echo $customerinfo->firstname.' '.$customerinfo->lastname;?></h5>
            ...
            <div class="middle-data">
                ...
                <div class="item-info gap_right">
                    ...
                    <h5 class="item-title"><?php echo display('table');?>:
                        <?php if(!empty($tableinfo)){echo $tableinfo->tablename;} ?></h5>
            ...
            <div class="text-center">
                ...
                <p class="b_top"><?php echo display('power_by_ESupport_Technologies')?></p>
