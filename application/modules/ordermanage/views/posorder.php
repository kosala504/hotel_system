                                    ...
                                    <div class="cardarea2 w-100 no-gutters row display-none ml-0">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" placeholder="Account Number"
                                                id="account_number" name="account_number[]" value="" />
                            ...
                            <div class="card-body">
                                ...
                                <div class="cardarea2 w-100 no-gutters row display-none ml-0">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <label for="4digit" class="col-form-label"><?php echo "Bank Name"; ?></label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <label for="name" class="col-sm-4 col-form-label"><?php echo display('customer_type'); ?> <span
                            class="text-danger">*</span></label>

                    <div class="col-sm-6">

                        <select class="basic-single" onchange="newcustdatares()" name="newcustomer_typeres"
                            id="newcustomer_typeres">
                ...
                <span hidden id="old_cust_data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input readonly class="form-control simple-control" name="customer_nameold" id="nameold"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <label for="available_quantity"
                            class="col-sm-4 col-form-label"><?php echo display('avg_qty'); ?></label>

                        <div class="col-sm-8">

                            <input class="form-control" type="text" id="available_quantity"
                                placeholder="<?php echo display('unitres'); ?>" name="available_quantity"
                                readonly="readonly">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input class="form-control" type="text" id="unit"
                                placeholder="<?php echo display('unitres'); ?>" name="unit" readonly="readonly">
                    ...
                    <div class="form-group row">
                        ...
                        <label for="Rate" class="col-sm-4 col-form-label"><?php echo display('defaultrate'); ?> <span
                                class="color-red">*</span></label>
                    ...
                    <ul class="nav nav-tabs mb-2" role="tablist">
                        ...
                        <li class="nav-item">
                            ...
                            <a href="#home" id="home_active" role="tab" data-toggle="tab" title="New Order"
                                class="nav-link home newtab" onclick="giveselecttab(this)"><i
                        ...
                        <li class="nav-item">
                            ...
                            <a href="#profile" role="tab" data-toggle="tab" class="nav-link ongord newtab"
                                id="ongoingorder" onclick="giveselecttab(this),ongoingclick()"><i
                        ...
                        <li class="seelist2 nav-item">
                            ...
                            <a href="#qrorder" role="tab" data-toggle="tab" id="todayqrorder"
                                class="nav-link home newtab" onclick="giveselecttab(this)"><i
                                    class="fa fa-qrcode smallview"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <a href="#messages" role="tab" data-toggle="tab" class="nav-link torder newtab"
                                id="todayorder" onclick="giveselecttab(this),todayorderclick()"><i
                                    class="fa fa-first-order smallview"></i>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <div class="product-category">
                                                        ...
                                                        <div class="listcat"
                                                            onclick="getslcategory(<?php echo $key; ?>)">
                                                        ...
                                                        <div class="d-flex">
                                                            ...
                                                            <button type="button" class="btn btn-primary ml-l newclient"
                                                                ...
                                                                data-target="#client-info"><i
                                                                    class="ti-plus cust_is_add"></i></button>
                                                ...
                                                <div class="fixedclasspos">
                                                    ...
                                                    <div class="row d-flex flex-wrap align-items-center">
                                                        ...
                                                        <div class="col-sm-6 leftview">
                                                            ...
                                                            <input name="distype" id="distype" type="hidden" value="<?php if (!empty($settinginfo->discount_type)) {
                                                                    echo $settinginfo->discount_type;
                                                                } ?>" />

                                                            <input name="sdtype" id="sdtype" type="hidden" value="<?php if (!empty($settinginfo->service_chargeType)) {
                                                                    echo $settinginfo->service_chargeType;
                                                                } ?>" />
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div class="row m-0">
                                                                            ...
                                                                            <label for="date" class="col-sm-8 mb-0"><?php echo display('vat_tax1');
                                                                                if (!empty($settinginfo->vat)) {
                                                                                    echo '(' . $settinginfo->vat . '%)';
                                                                                } ?>:
                                                        ...
                                                        <!-- Order process (Quick order,Place Order,cancel, calculater) -->
                                                        <div class="col-sm-6 text-right">
                                                            ...
                                                            <!--POS Invoice place order button -->
                                                        ...
                                                        <!-- end the section (Quick order,Place Order,cancel, calculater)-->
                                                    </div>
