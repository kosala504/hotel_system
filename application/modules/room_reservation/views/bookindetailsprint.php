<div class="card-body" id="printArea">
  ...
  <div>
    ...
    <img src="<?php echo base_url();?><?php echo html_escape(!empty($commominfo->invoice_logo)?$commominfo->invoice_logo: 'assets/img/header-logo.png')?>" class="img-fluid mb-3" alt="">
      <div class="info"> 
        <h2>Dutch Caviar - Hikkaduwa</h2>
        <p><?php echo html_escape($storeinfo->address);?></br>
        <abbr title="Phone"><?php echo display('mobile') ?>:</abbr> <?php echo html_escape($storeinfo->phone);?></br>
        <?php echo html_escape($storeinfo->email);?></br>
        </p>
      </div><!--End Info-->
    ...
    <div>
					...
					<div>
						<table>
                            <tr class="service">
								<td class="tableitem"><p class="itemtext">Invoice Number</p></td>
								<td class="tableitem"><p class="itemtext">#<?php echo html_escape($bookinfo->booking_number);?></p></td>
							</tr>

                            <tr class="service">
                                <td class="tableitem"><p class="itemtext">Date</p></td>
                                <td class="tableitem"><p class="itemtext"><?php echo html_escape($bookinfo->date_time);?></p></td>
                            </tr>

                            <tr class="service">
                                <td class="tableitem"><p class="itemtext">Customer Name</p></td>
                                <td class="tableitem"><p class="itemtext"><?php echo html_escape((!empty($customerinfo->firstname)?$customerinfo->firstname.' '.$customerinfo->lastname:'User Deleted'));?><br></p></td>
                            </tr>

							<tr class="service">
								<td class="tableitem"><p class="itemtext">Room Type</p></td>
                                <?php
                                ...
                                <td class="tableitem"><p class="itemtext"><?php echo trim($allroomtype,",");?></p></td>
							</tr>

							<tr class="service">
								<td class="tableitem"><p class="itemtext">Room No</p></td>
								<td class="tableitem"><p class="itemtext"><?php echo html_escape(!empty($bookinfo->room_no)?$bookinfo->room_no:null);?></p></td>
							</tr>

                            <tr class="service">
								<td class="tableitem"><p class="itemtext">Check In</p></td>
								<td class="tableitem"><p class="itemtext"><?php echo html_escape($bookinfo->checkindate);?></p></td>
							</tr>
                            
                            <tr class="service">
								<td class="tableitem"><p class="itemtext">Check Out</p></td>
								<td class="tableitem"><p class="itemtext"><?php echo html_escape($bookinfo->checkoutdate);?></p></td>
							</tr>

                            <tr class="service">
								<td class="tableitem"><p class="itemtext">Booking Status</p></td>
								<td class="tableitem"><p class="itemtext"><?php if($bookinfo->bookingstatus==0){ echo display('pending');}if($bookinfo->bookingstatus==2){ echo display('complete');}if($bookinfo->bookingstatus==1){ echo display("cancel");}if($bookinfo->bookingstatus==4){ echo display("checkin");}if($bookinfo->bookingstatus==5){ echo display("checkout");}?></p></td>
							</tr>

                            <tr class="service">
								<td class="tableitem"><p class="itemtext">Adults</p></td>
								<td class="tableitem"><p class="itemtext"><?php echo html_escape($bookinfo->nuofpeople);?></p></td>
							</tr>
                            
                            <tr class="service">
								<td class="tableitem"><p class="itemtext">Number of rooms</p></td>
								<td class="tableitem"><p class="itemtext"><?php echo html_escape($bookinfo->total_room);?></p></td>
                            ...
                            <tr class="service">
								<td class="tableitem"><p class="itemtext">Nights</p></td>
								<td class="tableitem"><p class="itemtext"><?php echo html_escape($datediff); ?></p></td>
							</tr>
                            <?php
                ...
                <?php } ?>
                            ...
                            <tr class="service">
								...
								<td class="tableitem"><p class="itemtext"><b>Sub Total</b></p></td>
								<td class="tableitem"><p class="itemtext"><b><?php $grprice=$totalroom*$total;

                                    $grprice=$grprice;

                                    echo (($grprice!=0)?$grprice:$grprice=$total); $grprice -= $disamount->discountamount*$datediff;?></b></p></td>
							</tr>
                            ...
                            <tr class="service">
								<td class="tableitem"><p class="itemtext"></p></td>
								<td class="tableitem"><p class="itemtext"><b>Grand Total</b></p></td>
								<td class="tableitem"><p class="itemtext"><b><?php if($currency->position==1){echo html_escape($currency->curr_icon);}?><?php echo number_format($totaltax+$postedbill+$grprice,2);?><?php if($currency->position==2){echo html_escape($currency->curr_icon);}?></b></p></td>
							</tr>

                            <tr class="service">
								<td class="tableitem"><p class="itemtext"></p></td>
								<td class="tableitem"><p class="itemtext"><b>Paid Ammount</b></p></td>
								<td class="tableitem"><p class="itemtext"><b><?php if($currency->position==1){echo html_escape($currency->curr_icon);}?><?php if (!empty($bookinfo->paid_amount)){echo $bookinfo->paid_amount+$postedbill-$reducetax;} else echo "0";?><?php if($currency->position==2){echo html_escape($currency->curr_icon);}?></b></p></td>
							</tr>

                            <tr class="service">
								<td class="tableitem"><p class="itemtext"></p></td>
								<td class="tableitem"><p class="itemtext"><b>Due Ammount</b></p></td>
								<td class="tableitem"><p class="itemtext"><b><?php if($currency->position==1){echo html_escape($currency->curr_icon);}?><?php if (!empty($bookinfo->paid_amount)){echo ($grprice+$totaltax+$postedbill+$reducetax)-($bookinfo->paid_amount+$postedbill);} else echo html_escape($grprice+$totaltax+$postedbill);?><?php if($currency->position==2){echo html_escape($currency->curr_icon);}?></b></p></td>
							</tr>                            
						</table>
					</div>
